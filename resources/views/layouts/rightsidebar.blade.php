...
<aside class="col-md-3 sidebar97239">
    <div class="status-part3821">
        <h4>stats</h4> <a href="#"><i class="fa fa-question-circle" aria-hidden="true"> Question(20)</i></a> <i class="fa fa-comment" aria-hidden="true"> Answers(50)</i>
    </div>
...
<form action="{{ route('login') }}" method="post">
    ...
    <div class="login-part2389">
        ...
        <div class="input-group300"> <span><i class="fa fa-user" aria-hidden="true"></i></span>
            <input type="text" name="email" class="namein309" placeholder="E-mail">
        </div>
        <div class="input-group300"> <span><i class="fa fa-lock" aria-hidden="true"></i></span>
            <input type="password" name="password" class="passin309" placeholder="password">
        </div>
            <button type="submit" class="userlogin320">Log In</button>
        <div class="rememberme">
            <label>
                <input type="checkbox" checked="checked"> Remember Me</label> 
                <a href="{{ route('register') }}" class="resbutton3892">Register</a>
        </div>
    </div>
</form>
@endguest
